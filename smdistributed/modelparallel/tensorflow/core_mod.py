...
# expose the core API when modelparallel.tensorflow is imported
# these are moved to this file to prevent some circular imports
# file is named core_mod so as not to clash with the import of core in __init__.py
# this becomes relevant during patching of core.pp_rank in test_util.py
