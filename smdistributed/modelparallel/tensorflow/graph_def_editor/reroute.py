...
# First Party
from smdistributed.modelparallel.tensorflow.graph_def_editor import node, subgraph, util
  ...
  """
    ...
    for t0, t1 in zip(ts0, ts1):
        ...
        if not dtype0.is_compatible_with(dtype1):
            raise ValueError(
                "Dtypes {} and {} of tensors {} and {} are not "
        ...
        if not shape0.is_compatible_with(shape1):
            raise ValueError(
                "Shapes {} and {} of tensors {} and {} are not "
