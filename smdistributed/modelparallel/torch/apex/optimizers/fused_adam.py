...
class FusedAdam(torch.optim.Optimizer):
    ...
    :class:`smdistributed.modelparallel.torch.apex.optimizers.FusedAdam` may be used as a drop-in replacement for ``torch.optim.AdamW``,
    or ``torch.optim.Adam`` with ``adam_w_mode=False``::

        opt = smdistributed.modelparallel.torch.apex.optimizers.FusedAdam(model.parameters(), lr = ....)
        ...
        opt.step()

    :class:`smdistributed.modelparallel.torch.apex.optimizers.FusedAdam` may be used with or without Amp.  If you wish to use :class:`FusedAdam` with Amp,
    ...
    def __init__(self, params, lr=1e-3, bias_correction=True,
        ...
        if multi_tensor_applier.available:
            ...
            raise RuntimeError('smdistributed.modelparallel.torch.apex.optimizers.FusedAdam requires cuda extensions')
