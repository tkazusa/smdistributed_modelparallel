...
class FusedAdagrad(torch.optim.Optimizer):
    ...
    :class:`smdistributed.modelparallel.torch.apex.optimizers.FusedAdagrad`'s usage is identical to any ordinary Pytorch optimizer::
        opt = smdistributed.modelparallel.torch.apex.optimizers.FusedAdagrad(model.parameters(), lr = ....)
        ...
        opt.step()

    :class:`smdistributed.modelparallel.torch.apex.optimizers.FusedAdagrad` may be used with or without Amp.  If you wish to use :class:`FusedAdagrad` with Amp,
    ...
    def __init__(self, params, lr=1e-2, eps=1e-10,
        ...
        if multi_tensor_applier.available:
            ...
            raise RuntimeError('smdistributed.modelparallel.torch.apex.optimizers.FusedAdagrad requires cuda extensions')
