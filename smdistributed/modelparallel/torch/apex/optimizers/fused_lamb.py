...
class FusedLAMB(torch.optim.Optimizer):
    ...
    :class:`smdistributed.modelparallel.torch.apex.optimizers.FusedLAMB`'s usage is identical to any ordinary Pytorch optimizer::

        opt = smdistributed.modelparallel.torch.apex.optimizers.FusedLAMB(model.parameters(), lr = ....)
        ...
        opt.step()

    :class:`smdistributed.modelparallel.torch.apex.optimizers.FusedLAMB` may be used with or without Amp.  If you wish to use :class:`FusedLAMB` with Amp,
    ...
    def __init__(self, params, lr=1e-3, bias_correction=True,
        ...
        if multi_tensor_applier.available:
            ...
            raise RuntimeError('smdistributed.modelparallel.torch.apex.optimizers.FusedLAMB requires cuda extensions')
