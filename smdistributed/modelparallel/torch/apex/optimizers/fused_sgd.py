...
class FusedSGD(Optimizer):
    ...
    :class:`smdistributed.modelparallel.torch.apex.optimizers.FusedSGD` may be used as a drop-in replacement for ``torch.optim.SGD``::

        opt = smdistributed.modelparallel.torch.apex.optimizers.FusedSGD(model.parameters(), lr = ....)
        ...
        opt.step()

    :class:`smdistributed.modelparallel.torch.apex.optimizers.FusedSGD` may be used with or without Amp.  If you wish to use :class:`FusedSGD` with Amp,
    ...
    def __init__(self, params, lr=required, momentum=0, dampening=0,
        ...
        if multi_tensor_applier.available:
            ...
            raise RuntimeError('smdistributed.modelparallel.torch.apex.optimizers.FusedSGD requires cuda extensions')
