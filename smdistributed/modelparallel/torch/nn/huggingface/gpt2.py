...
if hf_transformers_available:
    ...
    def hf_gpt2_transformer_layer_init_hook(n_ctx, config, scale=False):
        if not scale:
            raise ValueError(f"scale argument of HuggingFace GPT-2 Block must be True.")
    ...
    def translate_state_dict_to_hf_gpt2(state_dict, max_seq_len):
        translated_state_dict = {}
